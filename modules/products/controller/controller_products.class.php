...
function alta_products(){
  ...
  if (empty($_SESSION['result_prodpic'])){
      $_SESSION['result_prodpic'] = array('result' => true, 'error' => "", "data" => "/FW-PHP-MVC-OO-JS-JQuery/media/default-avatar.png");
  }
  ...
  if(($result['result']) && ($result_prodpic['result'])) {
      $arrArgument = array(
        ...
        'cat1' => $result['data']['cat1'],
        'cat2' => $result['data']['cat2'],
        'cat3' => $result['data']['cat3'],
        'cat4' => $result['data']['cat4'],
      ...
      $arrValue = false;
      $path_model = $_SERVER['DOCUMENT_ROOT'] . '/FW-PHP-MVC-OO-JS-JQuery/modules/products/model/model/';
